...
pub const THEME: Theme = Theme {
  root: Style::new().bg(MENU_COLOR_BACKGROUND),
    tabs: Style::new().fg(MENU_COLOR_FOREGROUND).bg(MENU_COLOR_BACKGROUND),
    tabs_selected: Style::new().fg(MENU_COLOR_FOREGROUND).bg(MENU_COLOR_HIGHLIGHT),
    footer: Style::new().fg(MENU_COLOR_FOREGROUND).bg(MENU_COLOR_BACKGROUND),
